import unittest
from ladr.term_wrapper import Term, variables, constants, unary, binary, nary
...
class TestSympyTerm(unittest.TestCase):
    ...
    def test_variable_creation(self):
        ...
        self.assertEqual(repr(x), "variables('x')")
    ...
    def test_operator_overloading(self):
        ...
        self.assertIs(add_xy.args[0], x)
        self.assertIs(add_xy.args[1], y)
        ...
        self.assertIs(sub_ay.args[0], a)
        self.assertIs(sub_ay.args[1], y)
        ...
        self.assertIs(mul_xa.args[0], x)
        self.assertIs(mul_xa.args[1], a)
        ...
        self.assertIs(div_ab.args[0], a)
        self.assertIs(div_ab.args[1], b)
        ...
        self.assertIs(and_xy.args[0], x)
        self.assertIs(and_xy.args[1], y)
        ...
        self.assertIs(or_xa.args[0], x)
        self.assertIs(or_xa.args[1], a)
        ...
        self.assertIs(xor_ab.args[0], a)
        self.assertIs(xor_ab.args[1], b)
        ...
        self.assertIs(mul_term.args[1], a) # a
    ...
    def test_usage_example(self):
        ...
        self.assertIs(t1.args[0], x)
        self.assertIs(t1.args[1], y)
        self.assertEqual(str(t1), 'f(x,y)')
        t2 = g(x,y,a)
        self.assertEqual(t2.symbol, 'g')
        self.assertEqual(t2.arity, 3)
        self.assertIs(t2.args[0], x)
        self.assertIs(t2.args[1], y)
        self.assertIs(t2.args[2], a)
        self.assertEqual(str(t2), 'g(x,y,a)')
        t3 = f(t1,t2)
        self.assertEqual(t3.symbol, 'f')
        self.assertEqual(t3.arity, 2)
        self.assertIs(t3.args[0], t1)
        self.assertIs(t3.args[1], t2)
